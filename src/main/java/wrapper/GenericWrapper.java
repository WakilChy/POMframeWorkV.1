...
public class GenericWrapper implements WrapperMethod {
	...
	public void invokeApp(String url) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\SeleniumSoft\\chromedriver\\chromedriver.exe");
	...
	/*
	 * public void enterById(String idValue, String value) {
	...
	public void enterByXpath(String xpathValue, String phoneNumber) {
		driver.findElementByXPath(xpathValue).sendKeys(phoneNumber);
	}
	...
	public void takesnap() {
		...
		File tar = new File("./snapImage/image.png");
		try {
